...
function cadastrar(req, res) {
    ...
    if (logradouro == undefined || bairro == undefined || cidade == undefined || uf == undefined || estado == undefined || fk_agencia_endereco == undefined) {
        ...
        enderecoModel.cadastrar(logradouro, bairro, cidade, uf, estado, fk_agencia_endereco)
            .then(
                function (resultado) {
